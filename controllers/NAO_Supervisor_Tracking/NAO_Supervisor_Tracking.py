...
class NAO_Supervisor_Tracking(Supervisor):
    ...
    def initialNeedingNode(self):
        ...
        self.__node_sheet = {}
        self.__node_position = {}
        self.__node_orientation = {}
        self.__shared_info = {}
        ...
        for i in range(children.getCount()):
            ...
            if node.getDef() == 'BlueTeam_Striker':
                BlueTeam_Striker = node
                self.__node_sheet["BlueTeam_Striker"] = BlueTeam_Striker
                self.__node_position["BlueTeam_Striker"] = None
                self.__node_orientation["BlueTeam_Striker"] = None
            ...
            if node.getDef() == 'RedTeam_Goalkeeper':
                ...
                self.__node_position   ["goalkeeper_red"] = None
                self.__node_orientation["goalkeeper_red"] = None

            if node.getDef() == 'BlueTeam_Goalkeeper':
                BlueTeam_Goalkeeper = node
                self.__node_sheet["ReadTeam_Goalkeeper"] = BlueTeam_Goalkeeper
                self.__node_position   ["BlueTeam_Goalkeeper"] = None
                self.__node_orientation["BlueTeam_Goalkeeper"] = None

            if node.getDef() == 'STADIUMGOAL_RED':
                print('STADIUMGOAL_RED has been initialized')
                stadiumgoal_red = node
                self.__node_sheet["stadiumgoal_red"] = stadiumgoal_red
                self.__node_position   ["stadiumgoal_red"] = None
                self.__node_orientation["stadiumgoal_red"] = None

            if node.getDef() == 'STADIUMGOAL_BLUE':
                print('STADIUMGOAL_BLUE has been initialized')
    ...
    def __init__(self):
        ...
        self.has_initial = self.initialNeedingNode()
        try:
    ...
    def refresh_position(self):
        ...
        self.__shared_info = {
            ...
            # "defender_right": {"position": self.__node_position["defender_right"], "orientation": self.__node_orientation["defender_right"], "isholdingball": 0},
            ...
            "BlueTeam_DefenderLeft": {"position": self.__node_position["BlueTeam_DefenderLeft"],"orientation": self.__node_orientation["BlueTeam_DefenderLeft"]},
            "BlueTeam_DefenderRight": {"position": self.__node_position["BlueTeam_DefenderRight"],"orientation": self.__node_orientation["BlueTeam_DefenderRight"]},
            "football": {"position": self.__node_position["football"], "orientation": self.__node_orientation["football"]},
            "goalkeeper_red": {"position": self.__node_position["goalkeeper_red"],"orientation": self.__node_orientation["goalkeeper_red"]},
            "stadiumgoal_red": {"position": self.__node_position["stadiumgoal_red"],"orientation": self.__node_orientation["stadiumgoal_red"]},
            "stadiumgoal_blue": {"position": self.__node_position["stadiumgoal_blue"],"orientation": self.__node_orientation["stadiumgoal_blue"]},
        }
