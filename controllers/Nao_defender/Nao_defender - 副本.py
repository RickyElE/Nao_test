...
class Nao_Defender(Robot):
    ...
    def loadMotionFiles(self):
        ...
        This Function mainly loads the motion files from libraries
        '''
        self.forwards = Motion('F:/Mrobotic/TDP/Nao_test/libraries/Forwards.motion')
        self.backwards = Motion('F:/Mrobotic/TDP/Nao_test/libraries/Backwards.motion')
        self.shoot = Motion('F:/Mrobotic/TDP/Nao_test/libraries/Shoot.motion')
        self.turnleft40 = Motion('F:/Mrobotic/TDP/Nao_test/libraries/TurnLeft40.motion')
        self.turnright40 = Motion('F:/Mrobotic/TDP/Nao_test/libraries/TurnRight40.motion')
        self.sidestepleft = Motion('F:/Mrobotic/TDP/Nao_test/libraries/SideStepLeft.motion')
        self.sidestepright = Motion('F:/Mrobotic/TDP/Nao_test/libraries/SideStepRight.motion')
        self.KICK = Motion('F:/Mrobotic/TDP/Nao_test/libraries/KICK.motion')
        self.StandUpFromFront = Motion('F:/Mrobotic/TDP/Nao_test/libraries/StandUpFromFront.motion')
        self.StandUpFromBack = Motion('F:/Mrobotic/TDP/Nao_test/libraries/StandUpFromBack.motion')
        self.ReturnFromSide = Motion('F:/Mrobotic/TDP/Nao_test/libraries/ReturnFromSide.motion')
    ...
    def __init__(self):
        ...
        if "Red" in self.myName:
            self.oppo_striker = "BlueTeam_Striker"
            ...
            self.oppo_striker = "RedTeam_Striker"
    ...
    def intercepting(self):
        ...
        # print(f"my_position: {robot_position_round}")
        # mate_position_round = [float(round(k, bitsOfRound)) for k in self.mate_position]
        # print(f"mate_position: {mate_position_round}")
